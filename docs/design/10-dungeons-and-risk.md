...
| Depth Bracket | Gold Loss (max) | Low-Level Items (max) | Legendary Loss Chance |
|---|---|---|---|
| 1-24 | 0 | 0-1 (rare chance only) | 0% |
| 25-49 | ~1,000 | 1 | 0% |
| 50-74 | ~2,500 | 1-2 | 1% |
| 75-99 | ~4,000 | 2 | 2% |
| 100-124 | ~5,000 | 2-3 | 2.5% |
| 125-149 | ~6,000 | 3 | 3% |
| 150-174 | ~7,000 | 3-4 | 3.5-4% |
| 175-199 | ~7,500 | 4 | 4.5% |
| 200+ | 8,000 (cap) | 4 (cap) | 5% (cap) |

**Open flags:** dungeon enemy/difficulty scaling should likely align with these same breakpoints (not yet designed);
bracket flavor names/theming are a good future worldbuilding hook rather than showing players raw numeric ranges.
